...
static ub8 hash( register ub1 *k, register ub8  length,register ub8   level)
  /* the key */
...
--------------------------------------------------------------------
*/
static ub8 hash2( register ub8 *k, register ub8  length, register ub8  level)
{
  register ub8 a,b,c,len;
...
static ub8 hash3( register ub1 *k, register ub8  length, register ub8  level)
{
  register ub8 a,b,c,len;
